/* Το μη ASCII αρχείο pelates.dbs έχει τις ακόλουθες εγγραφές

*Ονοματεπώνυμο πελάτη								 (50 χαρακτηρες)
*Διέυθυνση κατοικίας								 (60 χαρακτηρες)
*Τηλέφωνα											 (50 χαρακτήρες)
*Αριθμός εγγραφής υπολοίπων στοιχείωνστο details.dbs (ακέραιος)

Το αρχείο details.dbs έχει τα ακόλουθα στοιχεία:

*Χρεωστικό πελάτη						(Πραγματικός)
*Ημερομηνία τελευταίας συναλλαγής		(8 χαρακτηρες)
*Όνομα τελευταίας συναλλαγής			(20 χαρακτήρες)

Να γίνει πρόγραμμα C δημιουργίας ASCII αρχείου με όνομα
report.txt του οποίου κάθ γραμμή έχει την ακόλουθη μορφή:

	Ονοματεπώνυμο Τηλέφωνα Νεο Χρεωστικο

Το αρχείο report.txt θα περιλαμβάνει μόνο εκείνους τους πελάτες που το χρεωστικό τους είναι
μεγαλυτερο από 1000€ και ο κωδικός τους περιέχεται στο μη ASCII αρχείο codes.dbs του οποίου κάθε
γραμμή του περιλαμβάνει ένεν κωδικό πελάτη. Στο pelates.dbs κάθε κωδικός ταυτίζεται με τον
άυξοντα κωδικό εγγραφης του. Το νέο Χρεωστικό είναι το παλιό με προσάυξηση 10%
*/
